...
#include "storage/mapping/Bind.hpp"
#include "storage/mapping/Mapper.hpp"
#include "storage/mapping/Row.hpp"
#include "storage/mapping/Statement.hpp"

template <typename F> decltype(auto) SqlExecutor::withStatement(std::string_view sql, F &&f) const {
...
std::optional<T> SqlExecutor::scalar(std::string_view sql, const Args &...args) {
